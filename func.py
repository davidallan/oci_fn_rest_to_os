...
def upload_from_rest(auth_type, ctx, signer, url, headers, target_bucket, target_object, restType, page_prop=None, page_limit=None, start_page_no=None, page_limit_cnt=None, dataProperty=None,pagingLinkProperty=None):
...
def handler(ctx, data: io.BytesIO = None):
    ...
    try:
      upload_from_rest(auth, ctx, signer, url, headers, target_bucket, target_objectname, pattern, page_prop, page_limit, start_page_no, page_limit_cnt, dataProperty,pagingLinkProperty)
